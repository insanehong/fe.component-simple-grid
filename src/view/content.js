 ...
 */
     ...
     * @constructor Content
     */
    var Content = ne.util.defineClass(Base.View, /**@lends Content.prototype */{
        eventHandler: {
        ...
        render: function() {
            ...
            var list = this.model.list,
                columnList = this.grid.option('columnList'),
                html = '',
                tbody = '',
            ...
            ne.util.forEachArray(columnList, function(columnName) {
                col += '<col>' +
                '</col>';
            }, this);
